...
let textSlider = new Swiper('.text-slider', {
	...
	// Arrows
	navigation: {
		nextEl: '.arrows__item.arrows__item_next',
		prevEl: '.arrows__item.arrows__item_prev',
	},
	// And if we need scrollbar
	scrollbar: {
		el: '.control-slider__scrollbar',
		draggable: true,
	},
	thumbs: {
		swiper: imgSlider
...
//========================================================================================================================================================
let sliderPaginationCountCurrent = document.querySelector('.slider-pagination-count__current');
let sliderPaginationCurrent = document.querySelector('.slider-pagination-current__num');
textSlider.on('slideChange', function () {
	let ind = textSlider.realIndex + 1;
	let indResult = ind >= 10 ? ind : `0${ind}`;
	gsap.to(sliderPaginationCountCurrent, .2, {
		force3D: true,
		y: -10,
		opacity: 0,
		ease: Power2.easeOut,
		onComplete: function () {
			gsap.to(sliderPaginationCountCurrent, .1, {
				force3D: true,
				y: 10,
			})
			sliderPaginationCountCurrent.innerHTML = indResult;
			sliderPaginationCurrent.innerHTML = indResult;
		}
	})
	gsap.to(sliderPaginationCountCurrent, .2, {
		force3D: true,
